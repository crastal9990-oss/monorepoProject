import { login, signInWithGithub, signInWithGoogle } from '../register/actions'
      ...
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              &ldquo;通过 AI 辅助总结与智能标签，我的知识管理效率提升了数倍。这是构建个人数字大脑的最佳实践。&rdquo;
            </p>
            <footer className="text-sm text-zinc-400">前端开发工程师</footer>
          </blockquote>
        </div>
      </div>
          ...
          <div className="grid gap-6">
            ...
            <form className="space-y-4">
              ...
              {searchParams?.message && (
                <p className="text-sm text-green-600 font-medium">{searchParams.message}</p>
              )}
